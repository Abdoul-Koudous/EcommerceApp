// Mapping statut → { label, className } pour l'affichage des badges.
// ⚠️ Ce fichier est dupliqué depuis l'app client (ce sont deux applications
// séparées ne partageant que le backend). Si tu changes les libellés ou
// couleurs ici, pense à répercuter le changement côté client aussi pour
// garder une cohérence visuelle entre les deux interfaces.
